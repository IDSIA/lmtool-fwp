...
filename = os.path.join(dirname, 'fast_lstm_v2_cuda.cu')
...
mod_causal_dot_product_cuda = load(
    ...
    name="fast_lstm_v2_forward",
    sources=[filename], verbose=True)

mod_causal_dot_backward_cuda = load(
    extra_cuda_cflags=['--ftemplate-depth=1024'],
    name="fast_lstm_v2_backward",
    sources=[filename], verbose=True)

causal_dot_product_cuda = mod_causal_dot_product_cuda.fast_lstm_v2_forward
causal_dot_backward_cuda = mod_causal_dot_backward_cuda.fast_lstm_v2_backward


class FastLSTMv2(torch.autograd.Function):
    ...
    def backward(ctx, grad_out, grad_cell):
        ...
        FastLSTMv2.dot_backward[Zi.device.type](
            grad_out,
            Ki.data,
            Vi.data,
            bi.data,
...
if __name__ == '__main__':
    ...
    out1, _ = fast_lstm_v2(z1i, k1i, v1i, b1i, W1i,
                           z1u, k1u, v1u, b1u, W1u,
                           z1o, k1o, v1o, b1o, W1o,
                           h0, c0)
    print("done.")

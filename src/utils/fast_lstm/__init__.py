...
causal_dot_backward_cuda = mod_causal_dot_backward_cuda.fast_lstm_backward


class FastLSTM(torch.autograd.Function):
    ...
    def forward(ctx,
        ...
        ctx.save_for_backward(rnn_out, cell_out, gate_i, update_u, gate_o,
                              Zi, Ki, Vi, Wi, bi,
                              Zu, Ku, Vu, Wu, bu,
                              Zo, Ko, Vo, Wo, bo,
                              V_old_i, V_old_u, V_old_o,
                              h_init, c_init)
        # cell_out is not supposed to be used!
        return rnn_out, cell_out

    @staticmethod
    def backward(ctx, grad_out, grad_cell):
        # !grad_cell is expected to be zeros!
        # Extract the saved tensors
        (rnn_out, cell_out, gate_i, update_u, gate_o,
         Zi, Ki, Vi, Wi, bi,
         Zu, Ku, Vu, Wu, bu,
         Zo, Ko, Vo, Wo, bo,
         V_old_i, V_old_u, V_old_o,
        ...
        FastLSTM.dot_backward[Zi.device.type](
            grad_out,
            Ki.data,
            Vi.data,
            bi.data,
...
if __name__ == '__main__':
    ...
    bsz, n_head, slen, d_head = 3, 5, 11, 16
    v_dim = d_head
    ...
    out1, _ = fast_lstm(z1i, k1i, v1i, b1i, W1i,
                        z1u, k1u, v1u, b1u, W1u,
                        z1o, k1o, v1o, b1o, W1o,
                        h0, c0)
    print("done.")
